...
### An ROC evaluation of the wlaking speed threshold as a mortality predictor #
...
Swedish_stroke2 <-Swedish_stroke[,c(-1,-3,-4,-7,-9)]
names(Swedish_stroke2)[6] <-"time"
names(Swedish_stroke2)[4] <-"status"
Swedish_stroke2$speed_diff <-Swedish_stroke2$speed_shoes - Swedish_stroke2$speed_barefeet
attach(Swedish_stroke2)
Swedish_stroke2 <-Swedish_stroke2[order(speed_shoes),]
detach(Swedish_stroke2)
Ss3 <- subset(Swedish_stroke2[c(1:35,100:134),])
